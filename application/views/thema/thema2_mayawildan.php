...
<head>
    ...
    <style>
        #over-lay {
            ...
            /* display: none; */
            padding-top: 352px;
            background-image: url("<?= base_url() ?>assets/images/cover_black04.jpg");
        ...
        <?php if ($data['id_pernikahan'] == '1000000') { ?>
        ...
        .hero .wedding-announcement .save-the-date:before {
            background-color: rgb(255 132 124 / 30%) !important;
        }
        .hero .wedding-announcement .save-the-date:after{
            background-color: rgba(255,132,124, 0.7) !important;
        }
    ...
    <div class="page-wrapper">
        ...
        <div onclick="playAudio()" type="button" id="over-lay">
            <div style="margin:0 auto;">
                <img src="<?= base_url() ?>assets/images/bg-penerima3.png" style="width: 170px;margin-top: 135px;">
              ...
              <!--   <div style="text-align:center;font-size: 12px;margin-top: 118px;">Sehubungan dengan adanya wabah Covid-19, kami akan menyelenggarkan acara pernikahan dengan <span style="font-weight: bold; font-size: 13px;">Mengundang Keluarga Besar Saja.</span> Mohon untuk mengikuti himbauan pemerintah sebagai berikut:</div>
                <div style="text-align:center;font-size: 12px;">1. Selalu menggunakan masker dan membawa handsanitizer pribadi</div>
                <div style="text-align:center;font-size: 12px;">2. Mematuhi protokol kesehatan dan menjaga jarak</div>
                <div style="text-align:center;font-size: 12px;">3. Jika sedang merasa sakit, dimohon untuk tetap beristirahat dirumah</div>
                <div style="text-align:center;font-size: 12px;">Semoga wabah Covid-19 segera berlalu dan kita semua selalu diberikan kesehatan, Terimakasih.</div> -->
        ...
        <?php if ($data['teks_protokol'] == '1') { ?>
            <section class="gift-registration-section section-padding">
                <div class="container">
                    ...
                    <div class="row content">
                        <div class="col col-lg-10 col-lg-offset-1">
                            <p><b>Ikuti protokol kesehatan dengan selalu mencuci tangan, berjaga jarak dan selalu menggunakan masker. Terimakasih.</b></p>
        ...
        <div class="col-md-12 fixed">
            <div style="text-align: center;color: yellow;font-size: 32px;font-weight: bold;margin-top: 5px; z-index:99999">STOP ROLLING PAGE</div>
        </div>
        <!-- start footer -->
        <footer id="footer" class="site-footer" style="background-image: url(<?= $gambar4 ?>);">
