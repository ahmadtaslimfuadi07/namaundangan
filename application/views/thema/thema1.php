                ...
                <div class="row row-bottom-padded-md">
                    <div class="col-md-6 text-center animate-box">
                        <div class="wedding-events">
                            <div class="ceremony-bg" style="background-image: url(<?= base_url() ?>assets/images/wed-ceremony.jpg);"></div>
                            <div class="desc">
                                <h3>Akad Nikah</h3>
                                <div class="row">
                    ...
                    <div class="col-md-6 text-center animate-box">
                        <div class="wedding-events">
                            <div class="ceremony-bg" style="background-image: url(<?= base_url() ?>assets/images/venue.jpg);"></div>
                            <div class="desc">
