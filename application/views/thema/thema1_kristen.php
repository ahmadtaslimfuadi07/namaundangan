    ...
    <div class="forscroll">
                ...
                <div class="row animate-box">
                    <div class="col-md-8 col-md-offset-2 animate-box">
                        <div class="col-md-12 text-center section-heading svg-sm colored">
                            ...
                            <!-- <h2 class="bismi">Bismillah</h2> -->
                            <p style="margin-top: 10px">Demikianlah mereka bukan lagi dua, melainkan satu. Karena itu, apa yang dipersatukan Allah, tidak boleh diceraikan manusia.</p>
                            <p><strong>Matius &mdash; 19:6 TB </strong></p>
                        </div>
                    </div>
                </div>
                <div class="row animate-box">
        ...
        <div data-section="tanggal" id="qbootstrap-countdown" data-stellar-background-ratio="0.5" class="bg-image2" style="background-image: url(<?= $gambar2 ?>);" data-section="wedding-day">
            ...
            <div class="display-over">
                <div class="container">
                    <div class="row animate-box">
                        <div class="col-md-12 section-heading text-center svg-sm colored" style="padding-bottom: 0px">
            ...
            <div class="container">
                <div class="row animate-box">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="col-md-12 text-center section-heading svg-sm colored">
                            <img src="<?= base_url() ?>assets/images/flaticon/svg/005-two.svg" class="svg" alt="Free HTML5 Bootstrap Template by QBootstrap.com">
                            <h2>Pemberkatan Nikah &amp; Resepsi</h2>
                            <div class="row">
                ...
                <div class="row row-bottom-padded-md">
                    <div class="col-md-6 text-center animate-box">
                        <div class="wedding-events">
                            <div class="ceremony-bg" style="background-image: url(<?= base_url() ?>assets/images/pemberkatan.jpg);"></div>
                            <div class="desc">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-md-pull-1">
                                        <div class="date">
                                            ...
                                            <span><?= substr($data['jam_akad_mulai'], 0, 5)  ?> WITA</span>
                                            <!-- <span><?= substr($data['jam_akad_selesai'], 0, 5) ?> WIB</span> -->
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 text-center animate-box">
                        <div class="wedding-events">
                            <div class="ceremony-bg" style="background-image: url(<?= base_url() ?>assets/images/gedungr.jpg);"></div>
                            <div class="desc">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-md-pull-1">
                                        <div class="date">
                                            <i class="icon-clock2"></i>
                                            <span><?= substr($data['jam_resepsi_mulai'], 0, 5)  ?> WITA</span>
                                            <!-- <span><?= substr($data['jam_resepsi_selesai'], 0, 5) ?> WIB</span> -->
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row animate-box">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="col-md-12 text-center section-heading svg-sm colored">
                            <img src="<?= base_url() ?>assets/images/flaticon/svg/005-two.svg" class="svg" alt="Free HTML5 Bootstrap Template by QBootstrap.com">
                            <h2>Lokasi Resepsi Pernikahan</h2>
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1 subtext">
