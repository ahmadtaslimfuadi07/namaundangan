...
<head>
    ...
    <style>
        ...
        .hero .wedding-announcement .save-the-date:before {
            background-color: rgb(201 176 158 / 30%) !important;
        }
        .hero .wedding-announcement .save-the-date:after{
            background-color: rgba(201, 176, 158, 0.7) !important;
        }
        .header-style-1 .couple-logo a, .header-style-2 .couple-logo a{
            color: #C9B09E !important;
        }
        .wedding-couple-section .details .social-links a{
             background-color: #C9B09E !important;
        }
        ...
        .section-title h2, .section-title-white h2{
                background-color: rgba(201, 176, 158, 0.1);
        }
    ...
    <div class="page-wrapper">
        ...
        <div onclick="playAudio()" type="button" id="over-lay">
            <div style="margin:0 auto;">
                ...
                <div style="text-align:center;font-size: 12px;margin-top: 118px;">Sehubungan dengan anjuran Pemerintah terkait Wabah Covid-19, Kami menyampaikan bahwa penyelenggaraan acara pernikahan hanya dihadiri oleh <span style="font-weight: bold; font-size: 13px;">Keluarga Besar Saja.</span></div>
                <div style="text-align:center;font-size: 12px;">Mohon tetap mematuhi protokol kesehatan dengan cara selalu memakai masker, menjaga jarak, rajin mencuci tangan dan apabila merasa sakit dimohon tetap beristirahat dirumah.
Semoga kita selalu diberikan kesehatan. Terima Kasih.</div>
