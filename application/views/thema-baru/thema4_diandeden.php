            ...
            <center>
                <div class="popup-2">
                    ...
                    <p class="popup-2-2">
                        ...
                        <h3 style="font-family: 'Comfortaa', cursive; font-size: 34px;"><?= $tujuan ?> </h3>
                ...
                <div class="hide" onclick="play()"> Open Me </div> &nbsp;
                <div class="popup-3">
                    <div class="popup-2-3">
                        Information
                        <br><br>
    ...
    <div id="reception">
        ...
        <div id="reception-3" class="reception">
            <div class="reception-3 wow zoomIn">
                ...
                <div class="reception-3-2 reception-3-2-1">
                    <?php 
                    if(substr($data['jam_akad_selesai'], 0, 5) == ""){
        ...
        <div id="reception-3" class="reception">
            <div class="reception-3 wow zoomIn">
                ...
                <br>
                <div class="reception-3-2">
                   Kp. Ciconggang rt/rw 002/007, Desa Sukaharja Kec. Cijeruk Kab. Bogor
                </div>
                <div class="reception-3-3">
                    <img src="<?= base_url() ?>assets/images/placeholders.png">
                </div>
