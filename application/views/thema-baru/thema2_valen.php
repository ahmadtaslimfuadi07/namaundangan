...
<head>
    ...
    <style>
        #over-lay {
            ...
            /* display: none; */
            padding-top: 352px;
            background-image: url("<?= base_url() ?>assets/images/cover_black03.jpg");
    	...
    	<?php } $color1= "#720000"; $color2 = "114, 0, 0"; $color3 = "114 0 0";?>

        .hero .wedding-announcement .save-the-date:before {
            background-color: rgb(<?= $color3 ?> / 30%) !important;
        }
    ...
    <div class="page-wrapper">
        ...
        <div onclick="playAudio()" type="button" id="over-lay">
            <div style="margin:0 auto;">
                <img src="<?= base_url() ?>assets/images/bg-penerima2.png" style="width: 170px;margin-top: 135px;">
                    ...
                    <div class="col col-xs-12">
                        ...
                        <div class="gb groom">
                            <div class="img-holder right-align-text story-slider">
                                <?php foreach ($gambar as $it) {
                                    if ($it['jenis'] == '98') { ?>
                                 <img src="<?= $it['gambar'] ?>" alt class="img img-responsive">
                                <?php } }?>
                            </div>
                            <div class="details">
                            ...
                            <div class="row">
                                <div class="col col-md-6">
                                    <div class="story-text right-align-text">
                                        ...
                                        <p>Bryan and Valencia have grown up together and become a good friend since there were three years old. Then, on the 24th of April 2012, they committed to be in a relationship, and together they overcome the 6.5-year Long Distance Relationship. </p>
                                    </div>
                                </div>
                                <div class="col col-md-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-md-4">
                        <h2><span>And now....</span> One step closer to forever</h2>
                    </div>
                        ...
                        <div class="event">
                            ...
                            <h3>Akad Nikah</h3>
                                <ul>
                                    ...
                                    <li><i class="fa fa-clock-o"></i> Jum'at, <?php echo date_format($tanggal_akad, 'd') . ' ' . $bulan_akad . ' ' . date_format($tanggal_akad, 'Y') . ', ' . substr($data['jam_akad_mulai'], 0, 5) .' WIB';
                                ...
                                <p>Due to social distancing, unfortunately we will not be able to gather togetherin the church, but we humbly ask for your blessings and invite you to witness our Holy Matrimony through live stream.</p>
                                <a class="see-location-btn popup-with-form" href="#test-popup">
                                Live Stream Link <i class="fa fa-angle-right"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        ?>
                            <div class="event">
                                ...
                                <div class="details">
                                    ...
                                    <p>Due to COVID-19 pandemic that we are currently experiencing, our Thanksgiving will be attended only by close family and closest friends.</p>
        ...
        <section class="cta section-padding parallax" data-bg-image="<?= $gambar3 ?>" data-speed="7">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h2><span>So they are no longer two, but one. Therefore what God has joined together, let man not separate.</span> Matthew 19:6</h2>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
        </section>
