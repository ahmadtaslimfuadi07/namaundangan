...
<head>
    ...
    <meta property="og:url" content="https://www.limstudio.site" />
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/fonts/covid/flaticon.css">
...
<body>
    ...
    <style>
        ...
        /* 244, 161, 156, */
        <?php
            if($data["id_pernikahan"] == 34){
                $warna1 = "85, 83, 229";
                echo '.quotes-2{letter-spacing: 1px;font-size: 15px;}';
            }
            else if($data["id_pernikahan"] == 45){
                $warna1 = "89, 162, 114";
            }
            else if($data["id_pernikahan"] == 47){
                $warna1 = "61, 112, 191";
            }
            else{
                $warna1 = "244, 161, 156";
        ...
        ?>
        .popup-1 {
            border: 3px solid rgba(<?= $warna1 ?>, 1);
        }
        .popup-2-2{
            background-image: linear-gradient(to bottom, rgba(160, 155, 165, 1), rgba(<?= $warna1 ?>, 1));
        }
        .hide {
            background-color: rgba(<?= $warna1 ?>, 0.8);
        }
        .fa-heart {
            color: rgba(<?= $warna1 ?>, 1);
        }
        ...
        .slide-2-3-1 {
            background-color: rgba(<?= $warna1 ?>, 0.5);
            background-image: linear-gradient(to bottom, rgba(160, 155, 165, 0.5), rgba(<?= $warna1 ?>, 0.5));
        }
        #quotes, .music-box button {
            color: rgba(<?= $warna1 ?>, 1);
        }
        h1, #name h1 {
            background-image: linear-gradient(to bottom, rgba(160, 155, 165, 1), rgba(<?= $warna1 ?>, 1));
        }
        #reception, .guest-1 button, .comment-1, #footer, iframe {
            background-color: rgba(<?= $warna1 ?>, 1);
            background-image: linear-gradient(to bottom, rgba(160, 155, 165, 1), rgba(<?= $warna1 ?>, 1));
        }
        .grid-border {
            color: rgba(<?= $warna1 ?>, 1);
        ...
        .myButton {
            box-shadow: inset 0px -1px 11px -6px #f5c3b1;
            background: linear-gradient(to bottom, #ffdddb 5%, #eca39c 100%);
            ...
            padding: 5px 101px;
            text-decoration: none;
            text-shadow: -1px 1px 2px #a8635c;
            font-family: 'BeautyfaceDemo';
        }
        .myButton:hover {
            background:linear-gradient(to bottom, #eca39c 5%, #ffdddb 100%);
        ...
        <div class="popup-1">
            <center>
                <div class="popup-2">
                    ...
                    <p class="popup-2-2">
                        <?= $data['panggilan_l'] . ' dan ' . $data['panggilan_p'] ?>
                    </p>
                   
                    
                        <p style="margin-bottom: 5px;">Dear <?= $tujuan ?></p>
                        <!-- <h3 style="font-family: 'Comfortaa', cursive; font-size: 34px;"> </h3> -->
                        <p style="font-size: 14px;">we invite you to attend at our wedding</p>
                     
                    
                    <div class="popup-2-3">Sesuai dengan protokol kesehatan pencegahan Covid-19, diwajibkan agar tamu undangan hadir dengan memakai masker. Semoga kita semua diberikan kesehatan. Terima kasih.
                    </div>
                ...
                <div class="popup-3">
                    <div class="popup-2-3">
                        ...
                        Upload your best moment in our wedding day, make a romantic caption or tell your opinion about us. Don't forget to tag <?= $data['id_pernikahan'] != 31 ? $data["panggilan_l"] : '@zarzkias' ?> & <?= $data['id_pernikahan'] != 31 ? $data["panggilan_p"] : '@hasbiii20' ?> and insert hashtag #storyofBahagia.
        ...
        <div class="popup-1">
            <center>
                <div class="popup-2">
                    ...
                    <img src="<?= base_url() ?>assets/images/gallery/linkaja-ica.jpg" alt="" style="width:100%">
                </div>
                <div class="hide hide2" > Kembali </div> &nbsp;
                <div class="popup-3">
                    <!-- <i class="fa fa-music"></i> Christian Bautista - Since I Found You -->
                    <br>
                    <a href="https://instagram.com/limstudio_indo" class="popup-3-1">
    ...
    <div id="header">
        <div class="container">
            <div id="header-1">
                <span id="header-1-1" class="wow zoomIn"><?= $data['panggilan_l'] . ' | ' . $data['panggilan_p'] ?></span><br>
   ...
   <!--  <div id="on" onClick="play()" class="music">
    ...
    <div id="quote">
        <div class="container">
            <div id="quotes">
                <center>
                    <?php if($data["id_pernikahan"]== 34){ ?>
                    <i class="fa fa-heart" style="font-size: 30px;"></i>
                    <?php } else { ?>
                    <img src="<?= base_url() ?>assets/images/flowers.png">
                    <?php } ?>
                    <div class="quotes-2">
                        <?php echo ($data['id_pernikahan'] == 34) ? 'بِسْمِ اللّهِ الرَّحْمَنِ الرَّحِيْمِ' : 'Bismillah'; ?>
                    </div>
                    <div class="quotes-3">
                        وَ مِنۡ اٰیٰتِہٖۤ اَنۡ خَلَقَ لَکُمۡ مِّنۡ اَنۡفُسِکُمۡ اَزۡوَاجًا لِّتَسۡکُنُوۡۤا اِلَیۡہَا وَ جَعَلَ بَیۡنَکُمۡ مَّوَدَّۃً وَّ رَحۡمَۃً ؕ اِنَّ فِیۡ ذٰلِکَ لَاٰیٰتٍ لِّقَوۡمٍ یَّتَفَکَّرُوۡنَ
                        <br><br>
    ...
    <div id="name">
        ...
        <div class="name-2 name-3 wow zoomIn">
            ...
            <div class="name-2-3 name-2-3-2">
                <a href="https://instagram.com/<?= $ig_l ?>"><i class="fa fa-instagram"></i> <?= $ig_l ?></a>
                <br>
            </div>
        <?php } ?>
        </div>
        ...
        <div class="clear"></div>
        <div class="name-6 wow zoomIn" style="">
            <img src="<?= $brid ?>">
        </div>
        <div class="name-2 name-4 wow zoomIn">
            ...
            <?php if($ig_p != ''){ ?>
            <div class="name-2-3 name-2-3-2">
                <a href="https://instagram.com/<?= $ig_p ?>"><?= $ig_p ?> <i class="fa fa-instagram"></i></a>
                <br>
            </div>
            <?php } ?>
        </div>
    ...
    <div id="reception">
        ...
        <div id="reception-3" class="reception">
            <div class="reception-3 wow zoomIn">
                ...
                <div class="reception-3-2 reception-3-2-1">
                    ...
                    echo substr($data['jam_akad_mulai'], 0, 5).' ';
        ...
        <?php if($data['lokasi_resepsi'] != '' || $data['lokasi_resepsi'] != null){ ?>
    ...
    <div id="quote">
        <div class="container">
            <div id="quotes">
                <center>
                    <?php if($data["id_pernikahan"]== 31){ ?>
                   
                    
                    <div class="quotes-3">
                    Menikah bukan tentang seberapa besar cinta mu saat ini, tapi tentang seberapa banyak cinta yang akan kita bangun sampai akhir. Bukan pula tentang siapa yang lebih cepat menikah, tapi tentang menikah dengan orang yang tepat.
                    </div>
                    </div>
                    <?php }  ?>
                </center>
    ...
    <div class="grid-border"><a href="#" class="myButton modalhadiah">Beri Hadiah</a></div>
   
    <?php if($data['link_map'] != '' || $data['link_map'] != null){ ?>
    <div id="location">
        <div class="container">
    ...
    <!-- <div id="reception">
        ...
        <div id="reception-4" class="reception">
            <div class="reception-3 wow zoomIn">
                <br><br>
                <div class="reception-3-3 reception-4-1" style="margin-bottom: 60px;">
                    <i class="flaticon-thermometer" style="border: 3px #fff solid;border-radius: 62px;padding: 11px;"></i>
                </div>
                <div class="reception-3-2 reception-3-2-1 reception-4-2" style="margin-left: 30px; width: 75%;">
                    Cek suhu tubuh di pintu masuk
                </div>
                <div class="clear"></div>
                <div class="reception-3-3 reception-4-1" style="margin-bottom: 60px;">
                    <i class="flaticon-fever" style="border: 3px #fff solid;border-radius: 62px;padding: 11px;"></i>
                </div>
                <div class="reception-3-2 reception-3-2-1 reception-4-2" style="margin-left: 30px; width: 75%;margin-top: -18px;">
                    Apabila suhu tubuh tamu undangan diatas 37,2 derajat maka dipersilahkan menuju ke ruangan khusus
                </div>
                <div class="clear"></div>
                <div class="reception-3-3 reception-4-1" style="margin-bottom: 60px;">
                    <i class="flaticon-hand-wash" style="border: 3px #fff solid;border-radius: 62px;padding: 11px;"></i>
                </div>
                <div class="reception-3-2 reception-3-2-1 reception-4-2" style="margin-left: 30px; width: 75%;margin-top: -8px;">
                    Tamu wajib mencuci tangan dengan sabun di pintu masuk, Hand sanitizer disediakan
                </div>
                <div class="clear"></div>
                <div class="reception-3-3 reception-4-1" style="margin-bottom: 60px;">
                    <i class="flaticon-medical-mask" style="border: 3px #fff solid;border-radius: 62px;padding: 11px;"></i>
                </div>
                <div class="reception-3-2 reception-3-2-1 reception-4-2" style="margin-left: 30px; width: 75%;">
                    Mohon memakai masker
                </div>
                <div class="clear"></div>
